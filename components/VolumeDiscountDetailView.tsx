...
} from "@/app/volume-discounts/[sub]/data";
...
type VolumeDiscountDetailViewProps = {
  product: VolumeDiscountProduct;
  quickViewData: VolumeDiscountQuickViewData;
  prevHref: string | null;
  nextHref: string | null;
};

const VolumeDiscountDetailView = ({
  product,
  quickViewData,
  prevHref,
  nextHref,
}: VolumeDiscountDetailViewProps) => {
  ...
  const productName = `Series of 8 - ${getProductDisplayLabel(product.label)}`;
      ...
      <div className="mx-auto max-w-[1240px]">
        <div className="flex flex-col gap-4 pb-4 text-[14px] text-[#173b4d] sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Link href="/volume-discounts" className="hover:text-[#10069F]">
              Volume Discounts
            </Link>
            <span className="text-[#8aa0ad]">›</span>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[minmax(0,500px)_360px] lg:items-start lg:justify-center">
          ...
          <div className="text-center lg:pt-1">
            ...
            <div className="my-6 flex items-center justify-center gap-3">
              <span className="text-[28px] leading-none font-normal text-[#8ad400]">
                {product.price}
              </span>
...
export default VolumeDiscountDetailView;
