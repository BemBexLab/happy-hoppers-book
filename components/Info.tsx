...
const Info = () => {
  return (
    <section className="bg-white px-4 pb-8 pt-6 sm:px-6 sm:pt-8 md:px-10 lg:px-16 lg:pb-0 lg:pt-10">
      ...
      <div className="mx-auto grid max-w-5xl grid-cols-1 items-center lg:grid-cols-[58%_42%]">
        <motion.div
        ...
        >
          ...
          <div className="text-center">
            <p className="text-xl font-libra text-[#10069F] sm:text-2xl md:text-3xl">
              Website
            </p>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-[#2e2e2e] sm:text-base md:text-lg">
              <a href="mailto:happyhoppersbooks@gmail.com">
                HappyHoppersBooks@gmail.com
              </a>
            </p>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="flex items-center gap-4">
              <SocialIcon
                href="https://truthsocial.com/group/happy-hoppers-books"
                label="Truth Social"
                bg="#5448ef"
              >
                <svg
              ...
              <SocialIcon
                href="https://www.facebook.com/people/Happy-Hoppers-Books/61582321171109/?mibextid=wwXIfr&rdid=nY0SLJnAWN0g8uEN&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F19f3myA4Sg%2F%3Fmibextid%3DwwXIfr"
                label="Facebook"
                bg="#1877f2"
              >
                <svg
              ...
              <SocialIcon
                href="https://www.instagram.com/happyhoppersbooks?igsh=YWlxNXd4cjExa2Iw&utm_source=qr"
                label="Instagram"
                bg="#c13584"
              >
                <svg
              ...
              <SocialIcon
                href="https://x.com/MyHappyHoppers"
                label="X"
                bg="#000000"
              >
                <svg
